...
public class Main {
     ...
     * Only emails ending with "@mail.utoronto.ca" or "@utoronto.ca" are included,
     * and there must be at least one character before the "@".
    ...
    public static List<String> extractEmails(String str) {
        ...
        // then either mail.utoronto.ca or utoronto.ca
     ...
     * For example, "Amazing Apple" contains "A" twice, and "ABBA" contains "A" twice and "B" twice.
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Any text, then a capital letter (group 1), then any text, then the same capital letter again
